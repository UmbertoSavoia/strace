...
t_syscalls syscalls_64[] = {
        ...
        {"poll",					{ HEX, UINT, INT, NOPAR, NOPAR, NOPAR, }, INT},
        {"lseek",					{ UINT, HEX, UINT, NOPAR, NOPAR, NOPAR, }, LONG},
        {"mmap",					{ HEX, INT, PROT, MAP, INT, HEX, }, HEX},
        {"mprotect",				{ HEX, LONG, PROT, NOPAR, NOPAR, NOPAR, }, INT},
        {"munmap",					{ HEX, LONG, NOPAR, NOPAR, NOPAR, NOPAR, }, INT},
        {"brk",						{ HEX, NOPAR, NOPAR, NOPAR, NOPAR, NOPAR, }, HEX},
        {"rt_sigaction",			{ INT, HEX, HEX, LONG, NOPAR, NOPAR, }, INT},
        {"rt_sigprocmask",			{ INT, HEX, HEX, LONG, NOPAR, NOPAR, }, INT},
        ...
        {"readv",					{ HEX, HEX, HEX, NOPAR, NOPAR, NOPAR, }, LONG},
        {"writev",					{ HEX, HEX, HEX, NOPAR, NOPAR, NOPAR, }, LONG},
        {"access",					{ STR, INT, NOPAR, NOPAR, NOPAR, NOPAR, }, INT},
        {"pipe",					{ INT, NOPAR, NOPAR, NOPAR, NOPAR, NOPAR, }, INT},
        {"select",					{ INT, HEX, HEX, HEX, HEX, NOPAR, }, INT},
        ...
        {"faccessat",				{ INT, STR, INT, NOPAR, NOPAR, NOPAR, }, LONG},
